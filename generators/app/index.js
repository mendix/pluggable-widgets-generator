...
class MxGenerator extends Generator {
    ...
    prompting() {
        ...
        let dir = this._findMprFolder();

        this.prompt(promptTexts.promptWidgetProperties(dir, this.widgetParamName)).then(
            function (props) {
                this.props = props;
                this.prompt(promptTexts.promptTestsInfo(props)).then(
                    function (props) {
                        this.props = this.props ? Object.assign(this.props, props) : props;
                        done();
                    }.bind(this)
                );
            }.bind(this)
    ...
    _copyFiles(path, dest) {
        this._copyTemplate(this.templatePath(path), this.destinationPath(dest), this.widget);
    }
    ...
    _writeUtilityFiles() {
        ...
        if(this.widget.license){
            switch(this.widget.license.toLowerCase()){
                case "apache-2.0":
                    this._copyTemplate(this.templatePath("licenses/APACHE2"), this.destinationPath("LICENSE"), this.widget);
                    break;
                case "mit":
    ...
    _writeWidgetFiles() {
        ...
        if (this.widget.isTs) {
            if (this.widget.emptyTemplate) {
                this._copyWidgetFiles(this.widget.source + `${widgetSrcFolder}HelloWorldSample.tsx.ejs`,
                    `${widgetSrcFolder}HelloWorldSample.tsx`);
                this._copyWidgetFiles(this.widget.source + "src/WidgetName.tsx.ejs",
                    "src/" + widgetName + ".tsx");
            } else {
                    this._copyWidgetFiles(this.widget.source + `${widgetSrcFolder}BadgeSample.tsx.ejs`,
            ...
            if (this.widget.emptyTemplate) {
                this._copyWidgetFiles(this.widget.source + `${widgetSrcFolder}HelloWorldSample.jsx.ejs`,
                    `${widgetSrcFolder}HelloWorldSample.jsx`);
                this._copyWidgetFiles(this.widget.source + "src/WidgetName.jsx.ejs",
                    "src/" + widgetName + ".jsx");
            } else {
                    this._copyWidgetFiles(this.widget.source + `${widgetSrcFolder}BadgeSample.jsx.ejs`,
    ...
    _writePackage() {
        if(this.widget.isWeb) {
            if (this.widget.isTs) {
                this._copyTemplate(this.templatePath("packages/package.ts.json"), this.destinationPath("package.json"), this.widget);
            } else if (this.widget.isJs) {
                this._copyTemplate(this.templatePath("packages/package.js.json"), this.destinationPath("package.json"), this.widget);
            }
        }else{
            if (this.widget.isTs) {
                this._copyTemplate(this.templatePath("packages/package_native_ts.json"), this.destinationPath("package.json"), this.widget);
            } else if (this.widget.isJs) {
                this._copyTemplate(this.templatePath("packages/package_native_js.json"), this.destinationPath("package.json"), this.widget);
            }
        }
    }
    ...
    _writeCompilerOptions() {
        if (this.widget.isTs) {
            this._copyTemplate(this.templatePath("commons/tsconfig.json"), this.destinationPath("tsconfig.json"), this.widget);
        }
    }
        ...
        if (this.widget.unitTests) {
            if (this.widget.isWeb) {
                if (this.widget.fullTemplate) {
                    ...
                    this._copyWidgetFiles(this.widget.source + `${widgetSrcFolder}/__tests__/BadgeSample.spec.${extension}.ejs`,
                        `${widgetSrcFolder}/__tests__/BadgeSample.spec.${extension}`);
                }else{
                    this._copyFile(
                        this.templatePath(`${this.widget.source}src/components/__tests__/HelloWorldSample.spec.${extension}.ejs`),
                ...
                if(this.widget.fullTemplate){
                    this._copyFile(
                        this.templatePath(`${this.widget.source}src/components/__tests__/BadgeSample.spec.${extension}.ejs`),
    ...
    _copyEndToEndTests() {
        ...
        if (this.widget.e2eTests && this.widget.isWeb) {
            if (this.widget.isTs) {
                this._copyFile(this.templatePath("typings/WebdriverIO.d.ts"),
                    this.destinationPath("tests/e2e/typings/WebdriverIO.d.ts"));
                this._copyFile(this.templatePath(this.widget.source + "tests/e2e/tsconfig.json"),
            ...
            this._copyFile(this.templatePath(`${this.widget.source}tests/e2e/pages/home.page.${extension}.ejs`),
